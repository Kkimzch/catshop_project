                ...
                <div class="container-fluid">
                    ...
                    <div>
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">แก้ไขบทความ</h1>
                        </div>
                    </div>
                            ...
                            <form method="POST" action="blog.php" enctype="multipart/form-data">
                                ...
                                <div class="container">
                                    <input type="text" class="form-control form-control-user d-none" id="blog_id"
                                        name="blog_id" value="<?php echo $row['blog_id']; ?>" required>
                                    <div class="row text-dark">
                                        ...
                                        <div class="col col-lg-9">
                                            <input type="text" class="form-control form-control-user" id="blog_title"
                                                name="blog_title" value="<?php echo $row['blog_title']; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row text-dark mt-3">
                                        ...
                                        <div class="col col-lg-9">
                                            ...
                                            <img width="50%" src="../images/blog/<?php echo $row['img']; ?>"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="blog.php" class="btn btn-primary">บันทึก</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
