	...
	<body>
		...
		<nav class="custom-navbar navbar navbar navbar-expand-md navbar-dark bg-dark" arial-label="Cat Shop navigation bar">
			...
			<div class="container">
				...
				<button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarsCat Shop" aria-controls="navbarsCat Shop" aria-expanded="false" aria-label="Toggle navigation">
		...
		<div class="untree_co-section before-footer-section">
            <div class="container">
                      ...
                      <tbody>
                        <tr>
                          <td class="product-thumbnail">
                            <img src="images/product1.1.png" alt="Image" class="img-fluid">
                          </td>
                          <td class="product-name">
                            <h2 class="h5 text-black">sdjisjdisjdisjisdcjisnvcdjfvnfdjnj</h2>
                          </td>
                          <td>$49.00</td>
                          <td>
              ...
              <div class="row">
                <div class="col-md-6">
                      <button class="btn btn-outline-black btn-sm btn-block">เลือกสินค้า</button>
                </div>
                <div class="col-md-6 pl-5">
                  <div class="row justify-content-end">
                    <div class="col-md-7">
                      ...
                      <div class="row">
                          <button class="btn btn-black btn-lg py-6 btn-block"  onclick="window.location='checkout.html'">ดำเนินการต่อ</button>
                      </div>
                    </div>
                  </div>
                </div>
