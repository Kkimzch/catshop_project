        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">ตั้งค่าโปรไฟล์</li>
                </ol>
            </nav>
            <div class="row p-1">
                                            ...
                                            <div class="form-group row mt-2">
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="text" class="form-control" id="c_tel" name="c_tel"
                                                        value="<?php echo $row['tel'];?>" required pattern="[0-9]{10}">
                                                </div>
                                            </div>
