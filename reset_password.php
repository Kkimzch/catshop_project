                ...
                <div class="col-3">
                    <div class="list-group">
                        ...
                        <a class="list-group-item list-group-item-action active rounded"
                            href="reset_password.php">เปลี่ยนรหัสผ่าน</a>
                    </div>
                </div>
                <div class="col-9">
                    <h4 class="text-dark">เปลี่ยนรหัสผ่าน</h4>
                            ...
                            <div class="p-3 p-lg-5 border bg-white">
                                <form action="reset_password_db.php" method="post">
                                    <div class="form-group row mt-2">
                                        <div class="col-md-12">
                                            <label for="c_tel" class="text-black">รหัสผ่านเดิม <span
                                    ...
                                    <div class="form-group row mt-2">
                                        <div class="col-md-12">
                                            <label for="c_tel" class="text-black">รหัสผ่านใหม่ <span
                                                    class="text-danger">*</span></label></label>
                                            <input type="password" class="form-control form-control-user"
                                                id="exampleInputPassword" name="exampleInputPassword" required>
                                        </div>
                                    </div>
                                    <div class="form-group row mt-2">
                                        <div class="col-md-12">
                                            <label for="c_tel" class="text-black">ยืนยันรหัสผ่านใหม่ <span
                                                    class="text-danger">*</span></label></label>
                                            <input type="password" class="form-control form-control-user"
                                                id="exampleRepeatPassword" name="exampleRepeatPassword" required>
                                            <span class="pl-3 small" id="password_error" style="color: red;"></span>
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-center mt-3">
                                        <button type="submit"
                                            class="btn btn-black btn-lg py-6 btn-block">บันทึก</button>
                                    </div>
                                </form>
                            </div>
                        </div>
